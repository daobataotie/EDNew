...
namespace Book.UI
{
    class Operations
    {
        ...
        static Operations()
        {
            ...
            //采购退货一览
            operations.Add("invoices.ct.edit-detail", (D1)delegate(System.Windows.Forms.Form form) { MM("Query.CTList", new Book.UI.Invoices.CT.ConditionForm()); });
            ...
            //外销报告数据输入页
            operations.Add("Book.UI.produceManager.PCExportReportANSI.DataInputForm", (D1)delegate(System.Windows.Forms.Form form) { M1("produceManager.PCExportReportANSI.DataInputForm", form); });
            ...
            operations.Add("Book.UI.AnnualknotturnForm", (D1)delegate(System.Windows.Forms.Form form) { M1("AnnualCarryoverForm", form); });
            //ISO出货报告
            operations.Add("produceManager.PCExportReportANSI.ISOOutPutFile", (D1)delegate(System.Windows.Forms.Form form) { M1("produceManager.PCExportReportANSI.ISOOutPutFile", form); });

            //发票编号设置
            operations.Add("AccountPayable.AcInvoiceXOBill.BillIdSetForm", (D1)delegate(System.Windows.Forms.Form form) { M1("AccountPayable.AcInvoiceXOBill.BillIdSetForm", form); });
