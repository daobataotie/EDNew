...
namespace Book.UI.produceManager.ProduceInDepot
{
    public partial class ROProductDefectRate : DevExpress.XtraReports.UI.XtraReport
    {
            ...
            : this()
        {
            ...
            this.TCmPinjianqita.DataBindings.Add("Text", this.DataSource, "mPinjianqita");
            this.TCmPinguanqita.DataBindings.Add("Text", this.DataSource, "mPinguanqita");
            this.TCmPodong.DataBindings.Add("Text", this.DataSource, "mPodong");
            this.TCmBowen.DataBindings.Add("Text", this.DataSource, "mBowen");
