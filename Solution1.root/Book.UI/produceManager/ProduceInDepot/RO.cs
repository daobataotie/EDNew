...
namespace Book.UI.produceManager.ProduceInDepot
{
    public partial class RO : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public RO(string produceInDepotId)
        {
            ...
            //this.xrTableCellProduceTransferQuantity.DataBindings.Add("Text", this.DataSource, Model.ProduceInDepotDetail.PRO_ProduceTransferQuantity);this.xrTableCellHeJiProceduresSum.DataBindings.Add("Text", this.DataSource, Model.ProduceInDepotDetail.PRO_HeJiProceduresSum);
