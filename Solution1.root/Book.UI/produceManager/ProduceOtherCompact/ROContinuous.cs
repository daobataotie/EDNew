...
namespace Book.UI.produceManager.ProduceOtherCompact
{
    ...
    public partial class ROContinuous : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public ROContinuous(ConditionOtherCompact condition)
        {
            ...
            IList<Model.ProduceOtherCompact> list = this.produceOtherCompactManager.Select(condition.ProduceOtherCompactId1, condition.ProduceOtherCompactId2, condition.StartDate, condition.EndDate, condition.SupplierId1, condition.SupplierId2, condition.ProductId1, condition.ProductId2, condition.InvoiceCusId);
