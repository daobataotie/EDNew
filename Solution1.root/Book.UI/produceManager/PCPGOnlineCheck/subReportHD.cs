...
namespace Book.UI.produceManager.PCPGOnlineCheck
{
    public partial class subReportHD : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public subReportHD()
        {
            ...
            this.TCtsl.DataBindings.Add("Text", this.DataSource, Model.ThicknessTest.PRO_Perspectiverate, "{0:0.####}");
            ...
            this.TCtslRight.DataBindings.Add("Text", this.DataSource, Model.ThicknessTest.PRO_PerspectiverateRight, "{0:0.####}");
