...
namespace Book.UI.Query
{
    public partial class Q54_1 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public Q54_1()
        {
            ...
            this.TCInvoiceUseQuantity.DataBindings.Add("Text", this.DataSource, Model.ProduceMaterialdetails.PRO_InvoiceXOId);
            this.TCKouliaori.DataBindings.Add("Text", this.DataSource, "Product." + Model.Product.PRO_StocksQuantity);
            ...
            this.TCParentProduct.DataBindings.Add("Text", this.DataSource, "ParentProduct." + Model.Product.PRO_ProductName);
            this.TCKouliaori.DataBindings.Add("Text", this.DataSource, Model.ProduceOtherMaterialDetail.PRO_KouliaoDate, "{0:yyyy-MM-dd}");
