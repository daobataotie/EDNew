...
namespace Book.UI.Query
{
    public partial class InDepotDetail : DevExpress.XtraReports.UI.XtraReport
    {
            ...
            : this()
        {
            ...
            IList<Model.DepotInDetail> details = manager.SelectByCondition(condition.StartDate, condition.EndDate, condition.InDepotIdStart, condition.InDepotIdEnd, condition.DepotIdStart, condition.DepotIdEnd, condition.SupplierStart, condition.SupplierEnd, condition.ProductId);
            if (details == null)
            ...
            this.TCPosition.DataBindings.Add("Text", this.DataSource, "DepotPosition." + Model.DepotPosition.PROPERTY_ID);
