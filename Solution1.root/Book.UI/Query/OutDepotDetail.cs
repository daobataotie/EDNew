...
namespace Book.UI.Query
{
    public partial class OutDepotDetail : DevExpress.XtraReports.UI.XtraReport
    {
            ...
            : this()
        {
            ...
            IList<Model.DepotOutDetail> details = this.manager.SelectByCondition(condition.StartDate, condition.EndDate, condition.OutDepotIdStart, condition.OutDepotIdEnd, condition.DepotStart, condition.DepotEnd, condition.ProductId, condition.InvoiceCusId);
