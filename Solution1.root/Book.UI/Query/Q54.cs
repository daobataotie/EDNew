...
namespace Book.UI.Query
{
    public partial class Q54 : XtraReport
    {
        ...
        public Q54(ConditionOtherMaterial condition)
        {
            ...
            IList<Model.ProduceOtherMaterial> list = otherManager.SelectByCondition(condition.StartDate, condition.EndDate, condition.SupplierId1, condition.SupplierId2, condition.ProduceOtherCompactId1, condition.ProduceOtherCompactId2, condition.ProductId1, condition.ProductId2, condition.InvoiceCusId);
            ...
            this.lblInvoiceCusId.DataBindings.Add("Text", this.DataSource, Model.ProduceOtherMaterial.PRO_InvoiceCusId);
