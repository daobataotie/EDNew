...
namespace Book.DA
{
    ...
    public partial interface IInvoiceCTAccessor : IInvoiceAccessor
    {
        ...
        IList<Model.InvoiceCT> SelectByCondition(DateTime dateStart, DateTime dateEnd, string ctStart, string ctEnd, string coStart, string coEnd, string CusId, string supplierid);
    }
}
