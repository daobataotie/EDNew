...
namespace Book.DA
{
    ...
    public partial interface IDepotInDetailAccessor : IAccessor
    {
        ...
        IList<Model.DepotInDetail> SelectByCondition(DateTime StartDate, DateTime EndDate, string InDepotIdStart, string InDepotIdEnd, string DepotIdStart, string DepotIdEnd, Model.Supplier SupplierStart, Model.Supplier SupplierEnd, string ProductId);
    }
}
