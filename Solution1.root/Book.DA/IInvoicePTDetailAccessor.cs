...
namespace Book.DA
{
    ...
    public partial interface IInvoicePTDetailAccessor : IEntityAccessor
    {
        ...
        IList<Book.Model.InvoicePTDetail> SelectByConditon(DateTime startTime, DateTime endTime, string invoiceId, string employeeId, string depot, string depotIn, string productId);
    }
}
