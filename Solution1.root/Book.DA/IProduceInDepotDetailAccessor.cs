...
namespace Book.DA
{
    ...
    public partial interface IProduceInDepotDetailAccessor : IAccessor
    {
        ...
        IList<Book.Model.ProduceInDepotDetail> SelectMonthCount(string startPronoteHeader, string endPronoteHeader, DateTime startDate, DateTime endDate, Model.Product product, Model.WorkHouse work, Model.Depot mDepot, Model.DepotPosition mDepotPositioin, string id1, string id2, string cusxoid, Model.Customer customer1, Model.Customer customer2, int ProductState);
