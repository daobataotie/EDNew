...
namespace Book.BL
{
    ...
    public partial class DepotInDetailManager
    {
        ...
        public IList<Model.DepotInDetail> SelectByCondition(DateTime StartDate, DateTime EndDate, string InDepotIdStart, string InDepotIdEnd, string DepotIdStart, string DepotIdEnd, Model.Supplier SupplierStart, Model.Supplier SupplierEnd, string ProductId)
        {
            return accessor.SelectByCondition(StartDate, EndDate, InDepotIdStart, InDepotIdEnd, DepotIdStart, DepotIdEnd, SupplierStart, SupplierEnd, ProductId);
        }
    }
}
