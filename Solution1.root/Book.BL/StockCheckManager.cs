...
namespace Book.BL
{
    ...
    public partial class StockCheckManager : BaseManager
    {
        ...
        public IList<Model.StockCheck> SelectByDateRage(DateTime StartDate, DateTime EndDate, string StockCheckId)
        {
            return accessor.SelectByDateRage(StartDate, EndDate, StockCheckId);
        }
