...
namespace Book.BL
{
    ...
    public partial class AcInvoiceXOBillManager : BaseManager
    {
        ...
        BL.BillIdDeletedManager BillIdDeletedManager = new BillIdDeletedManager();
        ...
        {
            acinvoiceXoBill = this.Get(acinvoiceXoBill.AcInvoiceXOBillId);
        ...
        private void Validate(Model.AcInvoiceXOBill AcInvoiceXOBill)
        {
            ...
            //if (AcInvoiceXOBill.AcInvoiceXOBillDate < DateTime.Now.Date)
            //    throw new Helper.InvalidValueException(Model.AcInvoiceXOBill.PRO_AcInvoiceXOBillDate);
        }
