    ...
    public partial class PCDoubleImpactCheckManager : BaseManager
    {
        ...
        public void Delete(Model.PCDoubleImpactCheck pcdic)
        {
            ...
            try
            {
                ...
                PCDICDAccessor.DeleteByPCDoubleImpactCheckId(pcdic.PCDoubleImpactCheckID);      //删除详细
        ...
        {
            return accessor.IsExistsPNTForInsert(PNTID, type);
        }

        public bool IsExistsPNTForUpdate(string PNTID, int? type, string PCDoubleImpactCheckID)
        {
            return accessor.IsExistsPNTForUpdate(PNTID, type, PCDoubleImpactCheckID);
        }
