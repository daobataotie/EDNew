...
namespace Book.BL
{
    public partial class PCExportReportANSIManager : BaseManager
    {
        ...
        public Model.PCExportReportANSI SelectByCusIdAndProduct(string InvoiceCusXoid, string productid, string type)
        {
            return accessor.SelectByCusIdAndProduct(InvoiceCusXoid, productid, type);
        }
