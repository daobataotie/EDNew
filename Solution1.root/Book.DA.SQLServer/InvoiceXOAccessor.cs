...
namespace Book.DA.SQLServer
{
    ...
    public partial class InvoiceXOAccessor : EntityAccessor, IInvoiceXOAccessor
    {
        ...
        {
            return sqlmapper.QueryForObject<string>("InvoiceXO.SelectByInvoiceCusID", Id);
        }

        public bool IsHasMps(string invoiceId)
        {
            return sqlmapper.QueryForObject<bool>("InvoiceXO.IsHasMps", invoiceId);
        }

        public string SelectInvoiceYjrq(string invoiceid)
        {
            return sqlmapper.QueryForObject<string>("InvoiceXO.SelectInvoiceYjrq", invoiceid);
        }
