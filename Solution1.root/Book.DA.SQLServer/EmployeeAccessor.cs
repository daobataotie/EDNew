    ...
    public partial class EmployeeAccessor : EntityAccessor, IEmployeeAccessor
    {
        ...
        public DataSet SelectOnActiveDataSet()
        {
            using (SqlConnection conn = new SqlConnection(sqlmapper.DataSource.ConnectionString))
            {
                ...
                SqlDataAdapter da1 = new SqlDataAdapter("select cast(0 as bit) as IsChecked,e.DepartmentId,e.DutyId,e.EmployeeId,e.IDNo,e.EmployeeName,e.EmployeeGender,e.IsCadre,convert(int,e.DailyPay) as DailyPay,convert(int,e.MonthlyPay) as MonthlyPay,convert(int,e.DutyPay) as DutyPay,convert(int,e.PostPay) as PostPay,convert(int,e.FieldPay) as FieldPay,convert(int,e.Insurance) as Insurance,convert(int,e.Tax) as Tax, DepartmentName,DutyName,Fromtime,ToTime from employee e left join Department on e.DepartmentId=Department.DepartmentId  left join Duty on e.dutyid=duty.dutyid  left join BusinessHours on BusinessHours.BusinessHoursId=e.BusinessHoursId" + " where left(IDNo,1) like ('[a-h]') and (EmployeeLeaveDate is null or EmployeeLeaveDate='" + Helper.DateTimeParse.NullDate.ToString("yyyy-MM-dd") + "') ORDER By (case when left(idno,1) like '[A-Za-z]' then (case when convert(int,substring(idno,2,2)) between 30 and 99 then left(idno,1)+cast(1911+convert(int,substring(idno,2,2)) as varchar(10)) + substring(idno,4,len(idno)) else left(idno,1)+convert(varchar(10),1911+convert(int,'1'+substring(idno,2,2)))+substring(idno,4,len(idno)) end ) else idno end) ", conn);
                SqlDataAdapter da2 = new SqlDataAdapter("select cast(0 as bit) as IsChecked,e.DepartmentId,e.DutyId,e.EmployeeId,e.IDNo,e.EmployeeName,e.EmployeeGender,e.IsCadre,convert(int,e.DailyPay) as DailyPay,convert(int,e.MonthlyPay) as MonthlyPay,convert(int,e.DutyPay) as DutyPay,convert(int,e.PostPay) as PostPay,convert(int,e.FieldPay) as FieldPay,convert(int,e.Insurance) as Insurance,convert(int,e.Tax) as Tax, DepartmentName,DutyName,Fromtime,ToTime from employee e left join Department on e.DepartmentId=Department.DepartmentId  left join Duty on e.dutyid=duty.dutyid  left join BusinessHours on BusinessHours.BusinessHoursId=e.BusinessHoursId" + " where left(IDNo,1) like ('o') and (EmployeeLeaveDate is null or EmployeeLeaveDate='" + Helper.DateTimeParse.NullDate.ToString("yyyy-MM-dd") + "') ORDER By (case when left(idno,1) like '[A-Za-z]' then (case when convert(int,substring(idno,2,2)) between 30 and 99 then left(idno,1)+cast(1911+convert(int,substring(idno,2,2)) as varchar(10)) + substring(idno,4,len(idno)) else left(idno,1)+convert(varchar(10),1911+convert(int,'1'+substring(idno,2,2)))+substring(idno,4,len(idno)) end ) else idno end) ", conn);
                SqlDataAdapter da3 = new SqlDataAdapter("select cast(0 as bit) as IsChecked,e.DepartmentId,e.DutyId,e.EmployeeId,e.IDNo,e.EmployeeName,e.EmployeeGender,e.IsCadre,convert(int,e.DailyPay) as DailyPay,convert(int,e.MonthlyPay) as MonthlyPay,convert(int,e.DutyPay) as DutyPay,convert(int,e.PostPay) as PostPay,convert(int,e.FieldPay) as FieldPay,convert(int,e.Insurance) as Insurance,convert(int,e.Tax) as Tax, DepartmentName,DutyName,Fromtime,ToTime from employee e left join Department on e.DepartmentId=Department.DepartmentId  left join Duty on e.dutyid=duty.dutyid  left join BusinessHours on BusinessHours.BusinessHoursId=e.BusinessHoursId" + " where left(IDNo,1) like ('[i-np-z]') and (EmployeeLeaveDate is null or EmployeeLeaveDate='" + Helper.DateTimeParse.NullDate.ToString("yyyy-MM-dd") + "') ORDER By (case when left(idno,1) like '[A-Za-z]' then (case when convert(int,substring(idno,2,2)) between 30 and 99 then left(idno,1)+cast(1911+convert(int,substring(idno,2,2)) as varchar(10)) + substring(idno,4,len(idno)) else left(idno,1)+convert(varchar(10),1911+convert(int,'1'+substring(idno,2,2)))+substring(idno,4,len(idno)) end ) else idno end) ", conn);
        ...
        public DataSet SelectOnActiveDataSetByEmployeeId(string employeeId)
        {
            using (SqlConnection conn = new SqlConnection(sqlmapper.DataSource.ConnectionString))
            {
                SqlDataAdapter da = new SqlDataAdapter("select cast(0 as bit) as IsChecked,e.*,DepartmentName,dutyname,Fromtime,ToTime from employee e left join Department on e.DepartmentId=Department.DepartmentId  left join Duty on e.dutyid=duty.dutyid  left join BusinessHours on BusinessHours.BusinessHoursId=e.BusinessHoursId where e.employeeId = '" + employeeId + "' order by IDNo", conn);
                DataSet ds = new DataSet();
                da.Fill(ds, "employee");
                return ds;
            }
        ...
        #region 排序时员工编号“O”开头的放在“H”后面
        public IList<Model.Employee> SelectOnActiveAtoH()
        {
            return sqlmapper.QueryForList<Model.Employee>("Employee.SelectOnActiveAtoH", Helper.DateTimeParse.NullDate);
        }

        public IList<Model.Employee> SelectOnActiveO()
        {
            return sqlmapper.QueryForList<Model.Employee>("Employee.SelectOnActiveO", Helper.DateTimeParse.NullDate);
        }

        public IList<Model.Employee> SelectOnActiveItoZWithoutO()
        {
            return sqlmapper.QueryForList<Model.Employee>("Employee.SelectOnActiveItoZWithoutO", Helper.DateTimeParse.NullDate);
        }

        public IList<Model.Employee> SelectHrDailyAttendA(DateTime date)
        {
            return sqlmapper.QueryForList<Model.Employee>("Employee.select_HrDailyAttendInfoByDayA", date.Date);
        }

        public IList<Model.Employee> SelectHrDailyAttendO(DateTime date)
        {
            return sqlmapper.QueryForList<Model.Employee>("Employee.select_HrDailyAttendInfoByDayO", date.Date);
        }

        public IList<Model.Employee> SelectHrDailyAttendI(DateTime date)
        {
