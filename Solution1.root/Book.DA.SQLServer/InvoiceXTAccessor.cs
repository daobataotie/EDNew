...
namespace Book.DA.SQLServer
{
    ...
    public partial class InvoiceXTAccessor : EntityAccessor, IInvoiceXTAccessor
    {
        ...
        public IList<Model.InvoiceXT> SelectByCondition(DateTime startDate, DateTime endDate, string CustomerId, string InvoiceCusId)
        {
            ...
            return sqlmapper.QueryForList<Model.InvoiceXT>("InvoiceXT.SelectByCondition", ht);
        }
    }
}
