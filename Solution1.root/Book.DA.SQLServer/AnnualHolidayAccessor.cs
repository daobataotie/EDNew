    ...
    public partial class AnnualHolidayAccessor : EntityAccessor, IAnnualHolidayAccessor
    {
        ...
        public void SaveAnnualInfo(System.Data.DataTable table, string years)
        {
            using (SqlConnection conn = new SqlConnection(sqlmapper.DataSource.ConnectionString))
            {
                ...
                da.UpdateCommand = new SqlCommand("update AnnualHoliday set HolidayDate=@HolidayDate,HolidayName=@HolidayName,Departs=@Departs,IsNationalHoliday=@IsNationalHoliday where AnnualHolidayId=@AnnualHolidayId", conn);

                SqlParameter[] UpdateParameters = new SqlParameter[]{
                new SqlParameter("@HolidayDate",SqlDbType.DateTime,50,"HolidayDate"),
                ...
                new SqlParameter("@IsNationalHoliday",SqlDbType.Bit,1,"IsNationalHoliday")
                };

                da.InsertCommand = new SqlCommand("insert into AnnualHoliday values(newid(),@HolidayDate,@HolidayName,'" + years + "',@Departs,@IsNationalHoliday)", conn);
        ...
        public bool IsNationalHoliday(DateTime datetime, string holidayName)
        {
            Hashtable ht = new Hashtable();
            ht.Add("HolidayDate", datetime.Date);
            ht.Add("HolidayName", holidayName);
            return sqlmapper.QueryForObject<bool>("AnnualHoliday.IsNationalHoliday", ht);
        }
    }
}
