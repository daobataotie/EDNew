...
namespace Book.Model
{
    ...
    public partial class PCImpactCheckDetail
    {
        ...
        public string Attr90TDis
        {
            get { return ValueToDisplay(_attr90T); }

        }

        public readonly static string PRO_Attr90TDis = "Attr90TDis";

        public string Attr90BDis
        {
            get { return ValueToDisplay(_attr90B); }
        }

        public readonly static string PRO_Attr90BDis = "Attr90BDis";
